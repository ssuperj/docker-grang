    ...
    <form action="/auth/loginProc" method="post">
      <div class="loginbox">
        ...
        <div class="box5">
          ...
          <div class="box6">
            <a
              href="https://kauth.kakao.com/oauth/authorize?response_type=code&client_id=3c4f59e8f00dd3b8e07672a870968fbd&redirect_uri=http://localhost:8090/auth/kakao/login&response_type=code"
              class="noneunderline"
            >
              <img
